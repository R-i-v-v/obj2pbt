...
def readData(path, uuid, parent, pbt_output, entry_name, readTextures, do_logging):
    ...
    object_number, g_count, face_count = 1, 0, 0
    folders, group_names = [], []
    ...
    if do_logging:
        return (vertices_by_line, face_maps_by_line, texture_cords_by_line, textures_by_index, textures, folders, group_names, output_file, input_file, logging_file, g_count, face_count)
    else:
        return (vertices_by_line, face_maps_by_line, texture_cords_by_line, textures_by_index, textures, folders, group_names, output_file, input_file, None, g_count, face_count)
